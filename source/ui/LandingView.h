...
private:
    ...
    private:
        ...
        // Kitöltött sziluett ikonok, jégkék (#4AA8E0) fill-lel beágyazva.
        // Gitár: game-icons.net (lorc, CC BY 3.0) — elektromos gitár sziluett.
        static constexpr const char* kGuitarSvg =
            ...
            "</svg>";
        // Mikrofon: Phosphor Icons (MIT) — microphone-stage, kézbefogós (stage) mic.
